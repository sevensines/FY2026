...
export default function ExpertJA() {
  return (
    <ExpertJATable cellPadding='0' cellSpacing='0' border='0' align='center'>
      <tbody>
        <tr>
          <td
            align='center'
                        ...
                        <tr>
                          ...
                          >
                            <span
                              ...
                              class='mobileAdjust'
                            >
                              引き続き Windows 8.1 をご案内下さい
                            </span>
                            <br />
                            Windows 10
                            について発表をいたしましたが、当面はこれまで通りの内容で
                            Windows 8.1 搭載 PC をしっかりとご案内ください。
                            現段階で積極的に Windows 10
                            無償アップグレードのご案内をする必要はありません。
                            <br />
                            <br />
                            <a
                              href=''
                              ...
                              style={{ color: "#68217a", fontWeight: "bold" }}
                              class='mobileAdjust'
                            >
                              詳しくはこちら
                            </a>
                      ...
                      <tbody>
                        <tr>
                          ...
                          >
                            ...
                            <br />
                            仕事にも趣味にも使える機能が備わっている Windows PC
                            およびタブレットは、ゲームをしたり、音楽を聴いたり、写真でスライド
                            ショーを作ったり、ビデオを見たり編集したりするのにもおすすめです。
                            <br />
                            <br />
                            <a
                              href=''
